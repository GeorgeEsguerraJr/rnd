 ...
 */
package com.sunlinei.cms.batch;
 ...
 *
 */
public final class BatchRunMain {

	private BatchRunMain() { }
	...
	public static void main(final String... args) throws InterruptedException {
		...
		final int count = jdbcTemplate.queryForObject("select count(*) from visinc", Integer.class);
